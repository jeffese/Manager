...
vetAccess('Accounts', 'Income', 'Add');

//$_bottons array(new, edit, delete, print, Nav, find)
$_bottons = array($access['Add'], 0, 0, 0, 0, 0);
//Button order: 0 first | 1 previous | 2 next | 3 last | 4 new | 5 edit | 6 save | 7 delete | 8 back | 9 refresh | 10 find | 11 print
$buttons_links = array("","","","","","","frmPayments","","index.php","","","","");
$rec_status = 2;

$editFormAction = $_SERVER['PHP_SELF'] . set_QS();

$outid = intval(_xses('OutletID'));
if (_xpost("MM_insert") == "frmPayments" && $outid > 0) {
	$sql = sprintf("INSERT INTO `%s`.`payments`(`OutletID`, `AccountID`, `EmployeeID`, 
            `InvoiceID`, `PaymentTitle`, `VendorType`, `VendorID`, `Payer`, `PaymentType`, 
            `Amount`, `PaymentDate`, `PaymentMethodID`, `PaymentMethod`, `AccountName`, 
            `AccountNumber`, `CheckNumber`, `CreditCardType`, `CheckDate`, `Status`, `Notes`) 
...
<script language="JavaScript1.2" type="text/javascript">
    var arrFormValidation=[
        ...
        ["AccountID", "", 
            ...
            ["eval=$('#VendorID').val()!=$('#AccountID').val()", 
                "Paying Account and Receiving Account ought to be different"],
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="<?php echo $editFormAction; ?>" onsubmit="return validateFormPop(arrFormValidation)" method="post" enctype="multipart/form-data" name="frmPayments" id="frmPayments">
              ...
              <tr>
                <td><table border="0" cellpadding="4" cellspacing="4">
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="InvoiceID" type="text" onchange="numme(this)" size="32" /></td>
                  </tr>
                  <tr>
                    <td class="titles">Description:</td>
                    <td><input name="PaymentTitle" style="width:300px" /></td>
                  </tr>
                  <tr>
                    ...
                    <td align="left"><table width="300" border="0" cellpadding="1" cellspacing="1">
                      ...
                      <tr>
                        <td colspan="2"><input name="Payer" id="Payer" style="width:300px" /></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="PaymentDate" type="text" id="PaymentDate" size="16" /></td>
                  </tr>
                  <tr>
            ...
            <input type="hidden" name="MM_insert" value="frmPayments" />
          </form>
          <table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>            </tr>
          </table></td>
