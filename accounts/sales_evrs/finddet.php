...
$sql = "SELECT DISTINCT items_prod.`ProductID`, `ProdName`
        ...
        WHERE OutletID IN ($outid) 
            OR ',$outid,' REGEXP CONCAT(',(', REPLACE(items_srv.`outlets`,',','|'), '),')
 ...
 Strict</b></td>
                  ...
                  <tr>
                    ...
                    <td><select size="5" id="Prodlist" onblur="getProds()">
                      ...
                      <option value="<?php echo $row_TProds['ProductID'] ?>"><?php echo $row_TProds['ProdName'] ?></option>
                      <?php } ?>
                    </select>
