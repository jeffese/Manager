...
if (_xpost("MM_update") == "frmsales") {
    try {
        ...
        $sql = sprintf("UPDATE `%s`.`invoices` SET `TotalValue`=%s,`Grandvalue`=%s,
            `Notes`=%s,`LedgerDate`=NOW() WHERE `InvoiceID`=%s AND Posted=0",
                    $_SESSION['DBCoy'],
                  ...
                  <tr>
                    <td colspan="2"><table width="100%" border="1" cellspacing="0" cellpadding="2" id="Tabdet">
                      ...
                      <tr id="itm_<?php echo $j ?>">
                        <td><a href="javascript: void(0)" onclick="removeItm(<?php echo $j ?>)"><img src="/images/delete.png" alt="" width="16" height="16" /></a>
