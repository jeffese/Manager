...
$buttons_links = array("","","","","","","","","","","frmreturn.submit()","","index.php");
$rec_status = 0;
...
$sql = "SELECT OrderRetID, $vendor_sql FROM `{$_SESSION['DBCoy']}`.`vendors` WHERE VendorType=5 ORDER BY `VendorName`";
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="240" valign="top"><img src="/images/Bills.jpg" width="240" height="300" /></td>
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="index.php" method="post" name="frmreturn" id="frmreturn">
 ...
 Strict</b></td>
                  ...
                  <tr>
                    <td class="titles">Job Description:</td>
                  ...
                  <tr>
                    ...
                    <td><select name="supervisor">
                      ...
                      <option value="<?php echo $row_TSup['OrderRetID'] ?>"><?php echo $row_TSup['VendorName'] ?></option>
                      <?php } ?>
                      </select></td>
                  </tr>
                  <tr>
