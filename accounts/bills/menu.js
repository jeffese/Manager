...
if (awmSupported){
    ...
    if(scriptNo==1){
        oBC=document.all.tags("BASE");
        if(oBC && oBC.length) if(oBC[0].href) mpi=oBC[0].href;
    }
    ...
    for (var i=0;i<e.length;i++){
        if (e[i].src){
            if (e[i].src.indexOf(awmMenuName+".js")!=-1){
                xt=e[i].src.split("/");
                if (xt[xt.length-1]==awmMenuName+".js"){
                    xt=e[i].src.substring(0,e[i].src.length-awmMenuName.length-3);
                    if (e[i].src.indexOf("://")!=-1){
                        mpi=xt;
                    }else{
                        if(xt.substring(0,1)=="/")mpi=mpa+xt; else mpi+=xt;
                    }
                }
            }
    }
...
while (awmMenuPath.search("'")>-1) {
    awmMenuPath=awmMenuPath.replace("'","%27");
}
...
function awmBuildMenu(){
    if (awmSupported){
		...
		it=s0.addItemWithImages(1,2,2," &nbsp;Journal Entries &nbsp;",n,n,"",n,n,n,3,3,3,n,n,n,"/accounts/bills/index.php",n,n,n,"/accounts/bills/index.php",n,0,0,2,4,5,5,6,7,7,1,1,1,0,0,n,n,n);
		it=s0.addItemWithImages(1,2,2," &nbsp;Payables &nbsp;",n,n,"",n,n,n,3,3,3,n,n,n,"/accounts/bills/payables.php",n,n,n,"accounts/bills/payables.php",n,0,0,2,4,5,5,6,7,7,1,1,1,0,0,n,n,n);
        s0.pm.buildMenu();
    }
}
