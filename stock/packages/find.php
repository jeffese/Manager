...
$buttons_links = array("","","","","","","","","","","frmpackage.submit()","","index.php");
$rec_status = 0;
...
$sql = "SELECT PackageID, $vendor_sql FROM `{$_SESSION['DBCoy']}`.`vendors` WHERE VendorType=5 ORDER BY `VendorName`";
...
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="index.php" method="post" name="frmpackage" id="frmpackage">
 ...
 Strict</b></td>
                  ...
                  <tr>
                    <td nowrap="nowrap" class="titles">Marital InUse </td>
                  ...
                  <tr>
                    ...
                    <td><select name="supervisor">
                      ...
                      <option value="<?php echo $row_TSup['PackageID'] ?>"><?php echo $row_TSup['VendorName'] ?></option>
                      <?php } ?>
                      </select></td>
                  </tr>
                  <tr>
