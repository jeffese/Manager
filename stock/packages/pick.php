...
$sql = "SELECT `ItemID`, `ProdName`, status.Category AS BrandName, catname, `UnitPrice`, shopinstock AS stock 
            {$From}{$orderval}";
...
onclick="parent.parent.appendItm(<?php echo "'", $row_TProducts['ItemID'], "','", str_replace(array('"', "'"), array('”', "’"), $row_TProducts['ProdName']), "','", $row_TProducts['UnitPrice'], "'" ?>)">
