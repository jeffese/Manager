...
$buttons_links = array("","","","","","","","","","","frmtransfer.submit()","","index.php");
$rec_status = 0;
...
$sql = "SELECT RequisitID, $vendor_sql FROM `{$_SESSION['DBCoy']}`.`vendors` WHERE VendorType=5 ORDER BY `VendorName`";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="index.php" method="post" name="frmtransfer" id="frmtransfer">
 ...
 Strict</b></td>
                  ...
                  <tr>
                    ...
                    <td><select name="supervisor">
                      ...
                      <option value="<?php echo $row_TSup['RequisitID'] ?>"><?php echo $row_TSup['VendorName'] ?></option>
                      <?php } ?>
                      </select></td>
                  </tr>
                  <tr>
