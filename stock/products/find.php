...
$buttons_links = array("","","","","","","","","","","frmprod.submit()","","index.php");
$rec_status = 0;
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="index.php" method="post" name="frmprod" id="frmprod">
 ...
 Strict</b></td>
                  ...
                  <tr>
                    ...
                    <td><select name="supervisor">
                      ...
                      <option value="<?php echo $row_TSup['VendorID'] ?>"><?php echo $row_TSup['ProdName'] ?></option>
                      <?php } ?>
                      </select></td>
                  </tr>
                  <tr>
