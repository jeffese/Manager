...
vetAccess('Stock', 'Products', 'Print');
...
?>
              ...
              <tr>
                <td><table border="0" cellspacing="4" cellpadding="4">
                  <tr>
                    <td colspan="2" valign="top" class="h1">Product Info</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td valign="top" class="titles">Description:</td>
                    <td align="left"><?php echo $row_TProducts['Description'] ?></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td><table border="0" cellspacing="4" cellpadding="4">
                  <tr>
                    <td valign="top" class="h1">Barcodes</td>
                  </tr>
                  <tr>
              ...
              <tr>
                <td><table border="0" cellspacing="4" cellpadding="4">
                  <tr>
                    <td colspan="2" valign="top" class="h1">Supply</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="titles">Units on Order:</td>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="2" cellspacing="2">
                  ...
                  <tr>
                    <td><?php echo $row_TProducts['Notes']; ?></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
