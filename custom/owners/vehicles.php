...
<script>
    function setVeh() {
        var vehs = "";
        $('input[name="veh"]:checked').each(function() {
            vehs += ',' + $(this).val();
        });
        parent.location.href = "../vehicles/index.php?v=" + vehs.substr(1);
    }
</script>
...
onclick="top.leftFrame.showMod('Vehicles', '/assets/vehicles/view.php?id=<?php echo $row_TVehicle['AssetID']; ?>')">
                                    <td align="center" nowrap="nowrap" bgcolor="<?php echo $rowdefcolor ?>" class="black-normal"><input type="checkbox" name="veh" value="<?php echo $row_TVehicle['AssetID'] ?>" <?php if (in_array($row_TVehicle['AssetID'], $_SESSION['new_veh'])) { ?>checked<?php } ?> />
              ...
              <tr>
                <td align="center"><img src="/images/but_update.png" width="70" height="20" style="cursor:pointer" onclick="setVeh()" /></td>
              </tr>
              </table>
            <table width="100%" border="0" cellspacing="4" cellpadding="4">
