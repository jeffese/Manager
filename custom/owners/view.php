...
$buttons_links = array("","","","","","edit.php?id=$id","","[Owner]del.php?id=$id","../kiosk.php","","find.php","|print.php?id=$id","");
$rec_status = 1;
...
$flow = _xses('flow');
$canEdit = $flow < 3 && $_SESSION['EmployeeID'] == $row_TClients['supervisor'] && $row_TClients['canedit'] < 2 ? 1 : 0;
//$_bottons array(new, edit, delete, print, Nav, find)
$_bottons = array(0, $access['Edit'] * $canEdit, $access['Del'] * $canEdit, 0, 0, 1, 0, 0, 1);
