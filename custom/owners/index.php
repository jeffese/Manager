...
$access = $_access['Customers'];
vetAccess('Clients', 'Customers', 'View');
        
//$_bottons array(new, edit, delete, print, Nav, find, fullscreen, email, main)
$_bottons = array($access['Add'], 0, 0, 0, 1, 1, 0, 0, 1);
//Button order: 0 first | 1 previous | 2 next | 3 last | 4 new | 5 edit | 6 save | 7 delete | 8 back | 9 refresh | 10 find | 11 print
$buttons_links = array("", "", "", "", "", "add.php", "", "", "../kiosk.php", "", "find.php", "", "");
$rec_status = 4;

qryfind('client', array('name'));
preOrd("client1", array('', 'vendorcode', 'CompanyName', 'InUse'));

$From = "FROM `{$_SESSION['DBCoy']}`.`vendors` WHERE VendorType=1 AND `leavstatus`=1 {$qryvals}";
