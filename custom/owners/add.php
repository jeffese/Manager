...
$buttons_links = array("","","","","","","frmclient","","../kiosk.php","","find.php","","");
$rec_status = 2;
...
$sql = "SELECT VendorID, $vendor_sql FROM `{$_SESSION['DBCoy']}`.`vendors` 
            WHERE VendorType>0 AND VendorType<5 ORDER BY `VendorName`";
$TClients = getDBData($dbh, $sql);

$TCat = getClassify(6);

$_SESSION['flow'] = _xget('flow');
?>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>
            <td style="height:30px; min-width:500px; background-image:url(../images/lblownernew.png); background-repeat:no-repeat">&nbsp;</td>
            </tr>
          <tr>
