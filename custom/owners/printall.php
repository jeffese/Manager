...
preOrd("client1", array('', 'vendorcode', 'CompanyName', 'VendorName', 'InUse'));

$From = "FROM `{$_SESSION['DBCoy']}`.`vendors` WHERE VendorType=1 {$qryvals}";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
              <tr>
                <td style="height:30px; min-width:460px; background-image:url(/images/lblcustomers.png); background-repeat:no-repeat">&nbsp;</td>
              </tr>
              <tr>
