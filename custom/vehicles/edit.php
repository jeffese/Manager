                  ...
                  <tr>
					...
					while (yr>=1900) {
                        ...
                        <div class="TabbedPanelsContent">
                          <table border="0" cellpadding="4" cellspacing="4">
                            <tr>
                              <td nowrap="nowrap" class="titles">Registration No.:
                                  <iframe style="display:none" id="licencenowin"></iframe></td>
                              <td><input type="text" name="licenceno" value="<?php echo $row_TAssets['licenceno'] ?>" size="32" onchange="vet_chk(this, 2, false)" />
                                  <input name="vetlicenceno" type="hidden" id="vetlicenceno" value="1" /><span id="licencenoprogress"></span></td>
                              </tr>
                            <tr>
                              <td nowrap="nowrap" class="titles">Chasis No.:
                                <iframe style="display:none" id="modelnowin"></iframe></td>
                              <td><input type="text" name="modelno" value="<?php echo $row_TAssets['modelno'] ?>" size="32" onchange="vet_chk(this, 3, false)" />
                                  <input name="vetmodelno" type="hidden" id="vetmodelno" value="1" /><span id="modelnoprogress"></span></td>
                              </tr>
                            <tr>
                              <td nowrap="nowrap" class="titles">Engine No.:
                                <iframe style="display:none" id="partnowin"></iframe></td>
                              <td><input type="text" name="partno" value="<?php echo $row_TAssets['partno'] ?>" size="32" onchange="vet_chk(this, 4, true)" />
                                  <input name="vetpartno" type="hidden" id="vetpartno" value="1" /><span id="partnoprogress"></span></td>
                            </tr>
                            <tr>
                              <td nowrap="nowrap" class="titles">Insurance No.:
                                <iframe style="display:none" id="insurancenowin"></iframe></td>
                              <td><input type="text" name="insuranceno" value="<?php echo $row_TAssets['insuranceno'] ?>" size="32" onchange="vet_chk(this, 5, true)" />
                                  <input name="vetinsuranceno" type="hidden" id="vetinsuranceno" value="1" /><span id="insurancenoprogress"></span></td>
                            </tr>
                            </table>
                          </div>
                        <div class="TabbedPanelsContent">
