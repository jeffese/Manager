...
<input type="hidden" name="serials_###" id="serials_###" value="'+serials+'" />\n\
<input type="hidden" name="serialized_###" id="serialized_###" value="'+serialized+'" /></td>\n\
<td>&nbsp;</td>\n\
<td id="Name_###">'+name+'</td>\n\
<td><input type="text" name="units_###" id="units_###" value="1" readonly="readonly"'+act+' style="width:20px" /></td>\n\
<td id="UnitPrice_###">'+setthous(price)+'</td>\n\
<td><input type="text" name="Discnt_###" id="Discnt_###" value="0" readonly="readonly" dscItm(###)" style="width:30px" /></td>\n\
<td><input type="text" name="Discount_###" id="Discount_###" value="0" readonly="readonly" discItm(###)" style="width:40px" /></td>\n\
<td><input type="text" name="TaxRate_###" id="TaxRate_###" value="'+tax+'" readonly="readonly" calItm(###)" style="width:20px" /></td>\n\
<td id="SalePrice_###">'+setthous(price)+'</td>\n\
<td id="LineTotal_###">'+setthous(price)+'</td></tr>';
...
function calItm(idx, sum) {
    ...
    $("#UnitPrice_"+idx).html(setMoney(unitp));
    $("#units_"+idx).html(setMoney(qty));
    $("#Discount_"+idx).html(setMoney(dsc));
