...
if (_xpost("MM_insert") == "frmstud") {
	...
	if ($insert > 0) {
		...
		$pix = newpix(ROOT . STUDPIX_DIR, '', $recid, 20, array(600, 200));
                    ...
                    <div class="TabbedPanelsContent">
                      <table border="0" cellspacing="4" cellpadding="4">
                        <tr>
                          ...
                          <td align="left"><select name="parentcompany" id="parentcompany">                            <option value="0">Select One </option>
                            <?php foreach ($TGuard as $row_TGuard) { ?>
                            <option value="<?php echo $row_TGuard['VendorID'] ?>"><?php echo $row_TGuard['VendorName'] ?></option>
                            <?php } ?>
                            </select></td>
                          </tr>
                        <tr>
                      ...
                      <table border="0" cellspacing="4" cellpadding="4">
                        <tr>
                          <td width="120" class="titles">Program:
                            <input name="DeptID" type="hidden" id="DeptID" /></td>
                          <td width="322" align="left" id="prog_txt">&nbsp;</td>
                          </tr>
                        <tr>
                          <td width="120" class="titles">Class:                            </td>
                          <td align="left" id="class_txt">&nbsp;</td>
                          </tr>
                        <tr>
                          <td class="titles">&nbsp;</td>
                          <td align="center"><input type="button" name="btprog" id="btprog" value="Select" onclick="return GB_showCenter('Program & Class', '/acad/students/progpick.php', 480,520)" />
                            <input type="button" name="clr" id="clr" value="Clear" onclick="				this.form.DeptID.value= '';				document.getElementById('prog_txt').innerHTML='';				document.getElementById('class_txt').innerHTML=''" /></td>
                          </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td align="left"><select name="categoryid">
                            ...
                            <option value="<?php echo $row_TCat['CategoryID'] ?>"><?php echo $row_TCat['Category'] ?></option>
                            <?php } ?>
                            </select>
...
window.onload = function() {
	...
	mCal3.setSkin('dhx_black');
            ...
            <input type="hidden" name="MM_insert" value="frmstud" />
          </form>
          <table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>            </tr>
          </table></td>
