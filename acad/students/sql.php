...
function findRec() {
    ...
    if (isset($_POST['name']) || isset($_GET['cls'])) {
        $pst = $namval . $orgval . $jobval . $locval . $accval . $addval . $notval;
        $ct = $gndval + $marval + $relval + $ag1val + $ag2val + $natval + $dptval + $catval +
                $prjval + $bnkval + $plnval + $hspval + $insval + $supvel + $temval + $levval;
    }
