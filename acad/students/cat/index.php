...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" nowrap="nowrap" bgcolor="#CFCFCF"><table border="0" cellspacing="4" cellpadding="4">
      <tr>
        <td align="left" class="h1"><b>Student Status</b></td>
        </tr>
      <tr>
...
foreach ($TCat as $row_TCat) {
	...
	$rowdefcolor = ($k == 1) ? "#E5E5E5" : "#D5D5D5"; ?>
	  ...
	  onclick="location.href='view.php?id=<?php echo $row_TCat['CategoryID'] ?>'">
            <td bgcolor="<?php echo $rowdefcolor ?>"><?php echo $row_TCat['Category']; ?></td>
            </tr>
          <?php } ?>
          </table></td>
        </tr>
