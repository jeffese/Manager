...
if (!isset($_GET['cls']) || (!vetClass(intval(_xget('cls'))) && !vetFullClass(intval(_xget('clid'))))) vetAccess('Academics', 'Students', 'View');

//$_bottons array(new, edit, delete, print, Nav, find)
$_bottons = array($access['Add'], 0, 0, $access['Print'], 1, 1);
//Button order: 0 first | 1 previous | 2 next | 3 last | 4 new | 5 edit | 6 save | 7 delete | 8 back | 9 refresh | 10 find | 11 print
$buttons_links = array("","","","","add.php","","","","","","find.php$cls","printall.php$cls","");
$rec_status = 4;
...
<table width="100%" border="0" cellspacing="4" cellpadding="4">
              <tr>
                <td class="h1"><?php echo $TStudents[0]['prog_name'] ?> {<?php echo $TStudents[0]['stud_class'] ?>}</td>
              </tr>
              <tr>
                              ...
                              <td align="center" valign="top" bgcolor="#FFFBF0">
                                <table width="100%" cellpadding="4" cellspacing="1" style="border: 2px #CCCCCC">
                                  <tr align="center" bgcolor="#666666" class="boldwhite1">
                                    ...
                                    <td nowrap="nowrap"><?php echo setOrderTitle('Class', $currentPage, 4, $ord, $asc); ?></td>
...
onmouseover="setPointer(this, <?php echo $j ?>, 'over', '<?php echo $rowdefcolor ?>', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <?php echo $j ?>, 'out', '<?php echo $rowdefcolor ?>', '#CCFFCC', '#FFCC99');" onclick="location.href='view.php?id=<?php echo $row_TStudents['VendorID'], (strlen($cls)>0 ? '&'.substr($cls, 1) :''); ?>'">
                                    ...
                                    <td align="center" bgcolor="<?php echo $rowdefcolor ?>" class="black-normal"><b><?php echo $row_TStudents['stud_class'] ?></b></td>
