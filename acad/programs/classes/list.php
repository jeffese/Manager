...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="240" valign="top"><img src="/images/clstudents.jpg" width="240" height="300" />
          <div id='mnulft' style="width:70%; height:200px; margin:30px"></div></td>
          <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
              <tr>
                <td style="height:30px; min-width:500px; background-image:url(/images/lblclstudents.png); background-repeat:no-repeat">&nbsp;</td>
              </tr>
              <tr>
                  ...
                  <script>
                      ...
                      tree.attachEvent("onDblClick",function(id){
                          ...
                          if (typ > 3) {
                              ...
                              arm_id = tree.getUserData(id,'id');
                              arm = tree.getUserData(par0, 'code');
                              cls_id = tree.getUserData(par0,'id');
                              
                              cls = tree.getItemText(par2) + ' > ' + 
                                  tree.getUserData(par1, 'code') +
                                  (arm.length == 0 ? '' : ' > ' + arm);
                              top.leftFrame.showMod('Students', '/acad/students/index.php?cls=' + 
                                  arm_id + '&clid=' + cls_id + '&clss=' + escape(cls));
                          } else {
                              tree.openItem(id);
                          }
                      });
