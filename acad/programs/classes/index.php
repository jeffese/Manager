...
$From = "FROM `{$_SESSION['DBCoy']}`.`sch_class` INNER JOIN `{$_SESSION['DBCoy']}`.`sch_programs` ON `sch_class`.`program`=`sch_programs`.`prog_id`";

$sql = "SELECT `sch_class`.*, `prog_name` {$From} ORDER BY `prog_name`";
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="240" valign="top"><img src="/images/class.jpg" width="240" height="300" />
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" valign="top" bgcolor="#FFFBF0"><table width="100%" border="0" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF">
                                <tr>
                                  <td bordercolor="#003300" bgcolor="#666666" class="boldwhite1">Program</td>
...
foreach ($TClass as $row_TClass) {
	...
	$rowdefcolor = ($k == 1) ? "#E5E5E5" : "#D5D5D5"; ?>
	  ...
	  onclick="location.href='view.php?id=<?php echo $row_TClass['class_id'] ?>'" 
	  ...
	  onmouseout="setPointer(this, <?php echo $j ?>, 'out', '<?php echo $rowdefcolor ?>', '#CCFFCC', '#FFCC99');">
                                  <td bgcolor="<?php echo $rowdefcolor ?>"><strong><?php echo $row_TClass['prog_name']; ?></strong></td>
                                  ...
                                  <td align="center" bgcolor="<?php echo $rowdefcolor ?>"><?php echo $row_TClass['cls_level']; ?></td>
                                </tr>
                                <?php } ?>
                              </table></td>
                            </tr>
                  ...
                  <script>
                      ...
                      tree.attachEvent("onDblClick",function(id){
                          ...
                          if (typ > 2) {
                              ...
                              dir = typ == 3 ? '' : 'arms/';
                              location.href = dir + 'view.php?id=' + itm;
                          } else {
                              tree.openItem(id);
                          }
                      });
