...
vetAccess('Academics', 'Certificates', 'Add');

//$_bottons array(new, edit, delete, print, Nav, find)
$_bottons = array($access['Add'], 0, 0, 0, 0, 0);
//Button order: 0 first | 1 previous | 2 next | 3 last | 4 new | 5 edit | 6 save | 7 delete | 8 back | 9 refresh | 10 find | 11 print
$buttons_links = array("","","","","","","frmcert","","index.php","","","","");
$rec_status = 2;

$editFormAction = $_SERVER['PHP_SELF'] . set_QS();

if (_xpost("MM_insert") == "frmcert") {
	$sql = sprintf("INSERT INTO `%s`.`sch_certificates` (`cert_name`, `cert_code`, `department`, `Notes`) VALUES (%s, %s, %s, %s)",
					   $_SESSION['DBCoy'],
      ...
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="<?php echo $editFormAction; ?>" onsubmit="return validateFormPop(arrFormValidation)" method="post" enctype="multipart/form-data" name="frmcert" id="frmcert">
              ...
              <tr>
                <td><table border="0" cellpadding="4" cellspacing="4">
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="cert_name" type="text" id="cert_name" size="32" /></td>
                    </tr>
                  <tr>
                    <td class="titles">Abbreviation:</td>
                    <td><input name="cert_code" type="text" id="cert_code" size="32" /></td>
                    </tr>
                  <tr>
            ...
            <input type="hidden" name="MM_insert" value="frmcert" />
          </form>
          <table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>            </tr>
          </table></td>
