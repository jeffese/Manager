...
foreach ($Tcat as $row_Tcat) {
    ...
    print('<item child="' . $ch . '" id="' . $cat_id . '#' . $row_Tcat["id"] . '#' . $row_Tcat["typ"] . '" text="' . $catname . '"><userdata name="type">' . $row_Tcat["typ"] . '</userdata><userdata name="id">' . $row_Tcat["id"] . '</userdata><userdata name="code">' . $cat_id . '</userdata></item>');
}
print("</tree>");
?>