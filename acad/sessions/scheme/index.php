...
$From = "FROM `{$_SESSION['DBCoy']}`.`sch_schemes`";

$sql = "SELECT * {$From} ORDER BY schm_name";
                            ...
                            <tr>
                              <td align="center" valign="top" bgcolor="#FFFBF0"><table width="100%" border="0" cellpadding="4" cellspacing="1" bordercolor="#FFFFFF">
                                <tr>
                                  ...
                                  <td bordercolor="#003300" bgcolor="#666666" class="boldwhite1">Part Name</td>
                                  <td bordercolor="#003300" bgcolor="#666666" class="boldwhite1">Parts</td>
                                  <td bordercolor="#003300" bgcolor="#666666" class="boldwhite1">Class Name</td>
                                </tr>
                                <?php $j=0;
foreach ($TSchem as $row_TSchem) {
	$j++;
	$k = $j % 2;
	$rowdefcolor = ($k == 1) ? "#E5E5E5" : "#D5D5D5"; ?>
	  ...
	  onclick="location.href='view.php?id=<?php echo $row_TSchem['schm_id'] ?>'">
                                  <td bgcolor="<?php echo $rowdefcolor ?>"><?php echo $row_TSchem['schm_name']; ?></td>
                                  <td bgcolor="<?php echo $rowdefcolor ?>"><?php echo $row_TSchem['term_name']; ?></td>
                                  <td bgcolor="<?php echo $rowdefcolor ?>"><?php echo $row_TSchem['term_no']; ?></td>
                                  <td bgcolor="<?php echo $rowdefcolor ?>"><?php echo $row_TSchem['class_name']; ?></td>
                                </tr>
                                <?php } ?>
                              </table></td>
                            </tr>
