...
$access = $_access['Course Selection'];
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="240" valign="top"><img src="/images/course_select.jpg" width="240" height="300" />
                  ...
                  <script>
                      ...
                      tree.attachEvent("onDblClick",function(id){
                          ...
                          if (typ == 6) {
                              ...
                              stud_id = tree.getUserData(id,'id');
                              studtxt = tree.getItemText(id);
                              
                              term_id = tree.getUserData(par0,'id');
                              term_cd = tree.getUserData(par0,'code');
                              ...
                              location.href = 'view.php?cid=' + arm_id + '&cls=' + escape(cls) + 
                                  ...
                                  '&sid=' + stud_id + '&std=' + escape(studtxt);
                          } else {
                              tree.openItem(id);
                          }
                      });
