...
$sql = "SELECT * FROM `{$_SESSION['DBCoy']}`.`sch_electives` WHERE `elect_id`=" . $_SESSION['offer_elect_id'];
$row_TElectives = getDBDataRow($dbh, $sql);

$sql = "SELECT * FROM `{$_SESSION['DBCoy']}`.`sch_course_offer` WHERE `offer_id`=" . _xses('offer_id');
...
<script type="text/javascript" src="../selection - Copy/course.js"></script>
