...
<table border="0" cellspacing="4" cellpadding="4">
              <tr>
                ...
                <td valign="top"><select name="lstcourse" size="20" class="titles" id="lstcourse" onchange="setCourse()">
                  <?php foreach ($TCourses as $row_TCourses) { ?>
                  <option value="<?php echo $row_TCourses['course_id'],'#',$row_TCourses['lecturer'],'#',$row_TCourses['VendorName'] ?>"><?php echo $row_TCourses['course'] ?></option>
                  <?php } ?>
                </select></td>
              </tr>
            </table>
