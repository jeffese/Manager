...
$sql = "SELECT `VendorID`, `vendorcode`, $vendor_sql, category_name,
        `amtbal`, `InUse`, `tax`, `contract` AS `ref_no`, `worked`, `salaryscale`.* 
            ...
            <tr>
              <td align="center" valign="top" bgcolor="#FFFBF0"><table width="100%" cellpadding="4" cellspacing="1" style="border: 2px #CCCCCC">
                <tr align="center" bgcolor="#666666" class="boldwhite1">
                  <td>#</td>
                  <td><input type="hidden" name="MM_update" value="fmlst" /><?php echo setOrderTitle('Staff No.', $currentPage, 1, $ord, $asc); ?></td>
                  ...
                  <td><?php echo setOrderTitle('Worked', $currentPage, 5, $ord, $asc); ?>
                    <input type="hidden" name="totalworked" id="totalworked" value="<?php echo $row_TPay['dys'] ?>" /></td>
...
onmouseout="setPointer(this, <?php echo $j ?>, 'out', '<?php echo $rowdefcolor ?>', '#CCFFCC', '#FFCC99');">
                  ...
                  <td><input type="text" name="worked<?php echo $j ?>" id="worked<?php echo $j ?>" value="<?php echo $row_TEmployees['worked'] ?>" style="width:40px" onChange="vetdays(<?php echo $j ?>)" /></td>
