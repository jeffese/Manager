...
$buttons_links = array("","","","","","","","","","","frmstaff.submit()","","index.php");
$rec_status = 0;
...
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="index.php" method="post" name="frmstaff" id="frmstaff">
 ...
 Strict</b></td>
                  ...
                  <tr>
                    ...
                    <td align="left"><table width="0" border="0" cellpadding="1" cellspacing="1" class="blacktxt">
                      <tr>
                          <td><input name="leavstatus" type="radio" value="-1" size="32" checked="checked" /></td>
                          <td>Any</td>
                          <td><input type="radio" name="leavstatus" value="0" size="32" /></td>
                          <td>No</td>
                          <td><input type="radio" name="leavstatus" value="1" size="32" /></td>
                          <td>Yes</td>
                        </tr>
                    </table></td>
                    </tr>
