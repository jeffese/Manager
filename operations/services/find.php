...
$buttons_links = array("","","","","","","","","","","frmservice.submit()","","index.php");
$rec_status = 0;
...
$sql = "SELECT ServiceID, $vendor_sql FROM `{$_SESSION['DBCoy']}`.`vendors` WHERE VendorType=5 ORDER BY `VendorName`";
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="index.php" method="post" name="frmservice" id="frmservice">
 ...
 Strict</b></td>
                  ...
                  <tr>
                    ...
                    <td><select name="supervisor">
                      ...
                      <option value="<?php echo $row_TSup['ServiceID'] ?>"><?php echo $row_TSup['VendorName'] ?></option>
                      <?php } ?>
                      </select></td>
                  </tr>
                  <tr>
