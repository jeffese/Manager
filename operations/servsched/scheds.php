...
$_bottons = array(0, 0, 0, $access['Print'], 1, 0);
//Button order: 0 first | 1 previous | 2 next | 3 last | 4 new | 5 edit | 6 save | 7 delete | 8 back | 9 refresh | 10 find | 11 print
$buttons_links = array("", "", "", "", "pick.php", "", "", "", "", "", "", "print.php", "");
$rec_status = 4;

$id = intval(_xget('id'));
preOrd('srvshed', array('', 'ProdName', 'AssetName', 'startdate', 'enddate', 'Category'));
...
$From = "FROM (
    ...
    LEFT JOIN `{$_SESSION['DBCoy']}`.`assets`               ON `sched`.AssetID=`assets`.AssetID
    LEFT JOIN `{$_SESSION['DBCoy']}`.`status`               ON `sched`.Status=status.CategoryID";

$sql = "SELECT SrvSchedID, startdate, enddate, `ProdName`, `sched`.`Status`, CONCAT(`AssetName`, ' ', `licenceno`) AS `AssetName`, status.Category {$From}{$orderval}";

$currentPage = 'scheds.php';
                    ...
                    <tr>
                      <td align="center" valign="top" bgcolor="#FFFBF0"><table width="100%" cellpadding="4" cellspacing="1" style="border: 2px #CCCCCC">
                        <tr align="center" bgcolor="#666666" class="boldwhite1">
                          ...
                          <td nowrap="nowrap"><?php echo setOrderTitle('Asset', $currentPage, 2, $ord, $asc); ?></td>
