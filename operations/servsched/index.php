...
$access = $_access['Service Schedule'];
vetAccess('Operations', 'Service Schedule', 'View');

//$_bottons array(new, edit, delete, print, Nav, find)
$_bottons = array($access['Add'], 0, 0, $access['Print'], 1, 0);
//Button order: 0 first | 1 previous | 2 next | 3 last | 4 new | 5 edit | 6 save | 7 delete | 8 back | 9 refresh | 10 find | 11 print
$buttons_links = array("", "", "", "", "pick.php", "", "", "", "", "", "", "printall.php", "");
$rec_status = 4;

preOrd('srvshed', array('', 'VendorName', 'ProductName', 'AssetName', 'startdate', 'enddate', 'Category', 'renew'));

$From = "FROM `{$_SESSION['DBCoy']}`.`items_srv_sched`
    ...
    LEFT JOIN `{$_SESSION['DBCoy']}`.`status`         ON `items_srv_sched`.Status=status.CategoryID";

$sql = "SELECT SrvSchedID, startdate, enddate, renew, ProductName, $vendor_sql, 
    AssetName, status.Category {$From}{$orderval}";
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="240" valign="top"><img src="/images/srvsched.jpg" width="240" height="300" /></td>
                            ...
                            <tr>
                              <td align="center" valign="top" bgcolor="#FFFBF0">
                                <table width="100%" cellpadding="4" cellspacing="1" style="border: 2px #CCCCCC">
                                  ...
                                  <td nowrap="nowrap"><?php echo setOrderTitle('Asset', $currentPage, 3, $ord, $asc); ?></td>
                                    <td nowrap="nowrap"><?php echo setOrderTitle('From', $currentPage, 4, $ord, $asc); ?></td>
                                  <td nowrap="nowrap"><?php echo setOrderTitle('To', $currentPage, 5, $ord, $asc); ?></td>
                                  <td nowrap="nowrap"><?php echo setOrderTitle('Status', $currentPage, 6, $ord, $asc); ?></td>
                                    <td nowrap="nowrap"><?php echo setOrderTitle('Renew', $currentPage, 7, $ord, $asc); ?></td>
                                    </tr>
                                  <?php $j=1;
...
onmouseover="setPointer(this, <?php echo $j ?>, 'over', '<?php echo $rowdefcolor ?>', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <?php echo $j ?>, 'out', '<?php echo $rowdefcolor ?>', '#CCFFCC', '#FFCC99');" onclick="location.href='view.php?id=<?php echo $row_TSrvsched['SrvSchedID']; ?>'">
                                    ...
                                    <td align="center" bgcolor="<?php echo $rowdefcolor ?>" class="black-normal"><b><?php echo $row_TSrvsched['ProductName'] ?></b></td>
                                    <td align="center" bgcolor="<?php echo $rowdefcolor ?>" class="black-normal"><b><?php echo $row_TSrvsched['AssetName'] ?></b></td>
                                    ...
                                    <td align="center" bgcolor="<?php echo $rowdefcolor ?>" class="black-normal"><input type="checkbox" <?php echo $row_TSrvsched['renew']==1? "checked=\"checked\"": ""; ?> disabled="disabled" /></td>
                                    </tr>
                                  <?php $j++;} ?>
                                  </table></td>
                            </tr>
