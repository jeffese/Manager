...
vetAccess('Clients', 'Customers', 'Print');
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
              <tr>
                <td style="height:30px; min-width:460px; background-image:url(/custom/images/lblowners.png); background-repeat:no-repeat">&nbsp;</td>
              </tr>
              </table>
                  ...
                  <tr>
                    ...
                    <td><table width="0" border="0" cellpadding="1" cellspacing="1" class="blacktxt">
                      <tr>
                        ...
                        <td><?php echo 1 == 4 ? 'Company Account' : 'Individual' ?></td>
                        ...
                        <td><?php echo 1 == 4 ? 'Bank' : 'Company' ?></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                ...
                <td><table width="100%" border="0" cellpadding="4" cellspacing="4" id="perstab">
                  ...
                  <tr>
                    ...
                    <td width="322"><table width="0" border="0" cellpadding="1" cellspacing="1" class="blacktxt">
                      <tr>
                        <td><input type="radio" name="sex" value="1" size="32" onclick="clientType(0, <?php echo 1 ?>)" <?php if (!(strcmp($row_TClients['sex'], 1))) { echo "checked=\"checked\""; } ?> disabled="disabled" /></td>
                        <td>Male</td>
                        <td><input type="radio" name="sex" value="2" size="32" onclick="clientType(1, <?php echo 1 ?>)" <?php if (!(strcmp($row_TClients['sex'], 2))) { echo "checked=\"checked\""; } ?> disabled="disabled" /></td>
                        <td>Fema
