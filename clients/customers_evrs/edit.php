                    ...
                    <div class="TabbedPanelsContent"><table border="0" cellpadding="4" cellspacing="4">
                      ...
                      <tr>
                        <td class="titles">Type:</td>
                          ...
                          <tr>
                                <td><input type="radio" name="ClientType" id="ClientType_1" value="1" size="32" <?php if (!(strcmp($row_TClients['ClientType'], 1))) { echo "checked=\"checked\""; } ?> /></td>
                                <td>Individual</td>
                                <td><input name="ClientType" type="radio" id="ClientType_2" value="2" size="32" <?php if (!(strcmp($row_TClients['ClientType'], 2))) { echo "checked=\"checked\""; } ?> /></td>
                                <td>Corporate</td>
                                <td><input name="ClientType" type="radio" id="ClientType_3" value="3" size="32" <?php if (!(strcmp($row_TClients['ClientType'], 3))) { echo "checked=\"checked\""; } ?> /></td>
                                <td>Government</td>
                            </tr>
                          </table></td>
                      </tr>
