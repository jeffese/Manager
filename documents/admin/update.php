...
for ($n = 0; $n<$num; $n++) {
    ...
    if (!$locked) {
        ...
        print "<a href='update.php?path=".urlencode($path_name)."&amp;site_id=$site_id&amp;exp=1' target='arch_win'><img src='yes.gif' width='10' height='10' border='0' align='middle' alt='".phpdigMsg('reindex')."' /></a>&nbsp;\n";
    }
    if ($path_name == "") {
...
<a href="index.php" target="arch_win">[<?php phpdigPrnMsg('back') ?>]</a> <?php phpdigPrnMsg('to_admin') ?>.
</body>
</html>