...
global $month_names;
if (preg_match('(([a-z]{3})\, ([0-9]{1,2}) ([a-z]+) ([0-9]{4}) ([0-9:]{8}) ([a-z]+))',$date,$regs))
    {
...
if (preg_match("[/]?mailto:|[/]?javascript:|[/]?news:",$eval)) {
   return -1;
}
...
if (is_array($result_test)
    ...
    switch ($result_test['status']) {
         ...
         case 'MSEXCEL':
         $usetool = true;
         $command = PHPDIG_PARSE_MSEXCEL.' '.PHPDIG_OPTION_MSEXCEL.' '.$tempfile2.' '.$tempfile2.'.csv';
         break;
