...
*****/
define('ABSOLUTE_SCRIPT_PATH','/documents'); // full path up to but not including admin dir, no end slash
...
define('PHPDIG_ADM_PASS','1'); //Password
...
$templates_array = array('corporate.html','grey.html','newspaper.html','yellow.html');
...
define('LINKS_MAX_LIMIT',999);           //max links per each level
...
define('PHPDIG_PARSE_MSWORD',DOC_LIB_DIR.'catdoc.exe');
define('PHPDIG_OPTION_MSWORD','-s 8859-1');

define('PHPDIG_INDEX_PDF',true);
define('PHPDIG_PARSE_PDF',DOC_LIB_DIR.'pdftotext.exe');
define('PHPDIG_OPTION_PDF','');

define('PHPDIG_INDEX_MSEXCEL',true);
define('PHPDIG_PARSE_MSEXCEL',DOC_LIB_DIR.'xls2csv.exe');
define('PHPDIG_OPTION_MSEXCEL','-q');

define('PHPDIG_INDEX_MSPOWERPOINT',true);
define('PHPDIG_PARSE_MSPOWERPOINT',DOC_LIB_DIR.'catppt.exe');
...
define('PHPDIG_MSEXCEL_EXTENSION','.csv');
