...
vetAccess('Administration', 'Currency', 'Add');

//$_bottons array(new, edit, delete, print, Nav, find)
$_bottons = array($access['Add'], 0, 0, 0, 0, 0);
//Button order: 0 first | 1 previous | 2 next | 3 last | 4 new | 5 edit | 6 save | 7 delete | 8 back | 9 refresh | 10 find | 11 print
$buttons_links = array("","","","","","","frmcurr","","index.php","","","","");
$rec_status = 2;

$editFormAction = $_SERVER['PHP_SELF'] . set_QS();

if (_xpost("MM_insert") == "frmcurr") {
	$sql = sprintf("INSERT INTO `%s`.`currencies` (`currencyname`, `symbol`, `code`, `unitname`, `unitsymbol`, `unitcode`, `fromrate`, `torate`, `fullname`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
					   $_SESSION['DBCoy'],
      ...
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="4" cellpadding="4">
          ...
          <form action="<?php echo $editFormAction; ?>" onsubmit="return validateFormPop(arrFormValidation)" method="post" enctype="multipart/form-data" name="frmcurr" id="frmcurr">
              ...
              <tr>
                <td><table border="0" cellpadding="4" cellspacing="4">
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="currencyname" type="text" id="currencyname" size="32" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="unitname" type="text" id="unitname" size="32" /></td>
                  </tr>
                  <tr>
                    <td class="titles">Unit Symbol:</td>
                    <td><input name="unitcode" type="text" id="unitcode" size="5" /></td>
                  </tr>
                  <tr>
                    <td class="titles">Exchange Rate:</td>
                    <td><strong>$</strong>
                      <input name="fromrate" type="text" id="fromrate" size="10" />
                       <strong>=</strong>
                       <input name="torate" type="text" id="torate" size="10" />
                        of this</td>
                  </tr>
                  <tr>
                    <td width="120" class="titles">Full Name:</td>
                    <td><input name="fullname" type="text" id="fullname" style="width:300px" /></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
            ...
            <input type="hidden" name="MM_insert" value="frmcurr" />
          </form>
          <table width="100%" border="0" cellspacing="4" cellpadding="4">
          <tr>            </tr>
          </table></td>
